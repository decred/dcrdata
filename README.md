...
| ----------- | ------- | ------------- | ------------------ | ---------------------------------- |
| Current     | 5.2     | `5.2-stable`  | `v5.2.0`           | ^6.1.1 (dcrd v1.5-pre@[`e7acd36b`](https://github.com/decred/dcrd/commit/e7acd36be3381288a46046ee9d7bc6cf2513aeb8) to `HEAD`) |
| Legacy      | 5.1     | `5.1-stable`  | `v5.1.3`           | ^5.0.0-^6.1.0 (dcrd v1.5-pre@[`fd3e180a`](https://github.com/decred/dcrd/commit/fd3e180a7e19fe72adaddd3d88370cb50fa636e2) to v1.5.0-pre@[`ccae4aa1`](https://github.com/decred/dcrd/commit/ccae4aa1a8a3ee8025bab6fee2f73d778d0315fd)) |
