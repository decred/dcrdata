...
export default class extends Controller {
  static get targets () {
    return [
      'bsubsidyPos', 'nextReductionTimer', 'difficulty', 'hashrate', 'hashrateDelta', 'bsubsidyPow', 'powConverted',
      'poolValue', 'ticketReward', 'poolSizePct', 'nextReductionTimer', 'blockHeight', 'powConverted', 'bsubsidyDev',
      'convertedDevSub', 'devFund', 'convertedDev', 'nextRewardReductionBlockHeight', 'remainingBlocksTillReduction'
    ]
  }
