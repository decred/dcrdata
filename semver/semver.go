...
// NewSemver returns a server version major.minor.patch
func NewSemver(major, minor, patch uint32) Semver {
	return Semver{major, minor, patch}
}

// Semver models a server version major.minor.patch
type Semver struct {
	major, minor, patch uint32
}

// SemverCompatible evaluates if the servers passed are compatible and returns a
// bool
