...
If you participate in the dcrdata.org community, we ask that you be mindful of
...
* **Be respectful.** Not all of us will agree all the time, but disagreement is
  ...
  dcrdata.org community should be respectful when dealing with other members and
