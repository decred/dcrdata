...
const (
	DayZoom    binLevel = "day"
	BlockZoom  binLevel = "block"
	WindowZoom binLevel = "window"
...
func ParseZoom(zoom string) binLevel {
	switch binLevel(zoom) {
	case BlockZoom:
		return BlockZoom
	case WindowZoom:
		return WindowZoom
...
func (charts *ChartData) cacheID(zoom binLevel) uint64 {
	switch zoom {
	case BlockZoom:
