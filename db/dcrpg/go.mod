...
require (
	...
	github.com/decred/dcrdata/blockdata/v5 v5.0.0
	...
	github.com/decred/dcrdata/mempool/v5 v5.0.0
	github.com/decred/dcrdata/rpcutils/v3 v3.0.0
	github.com/decred/dcrdata/semver v1.0.0
	github.com/decred/dcrdata/stakedb/v3 v3.1.0
