...
require (
	...
	github.com/decred/dcrdata/blockdata/v4 v4.0.0
	github.com/decred/dcrdata/db/cache/v2 v2.2.0
	github.com/decred/dcrdata/db/dbtypes/v2 v2.1.0
	github.com/decred/dcrdata/db/dcrpg/v4 v4.0.0
	github.com/decred/dcrdata/db/dcrsqlite/v4 v4.0.0
	...
	github.com/decred/dcrdata/mempool/v4 v4.0.0
	...
	github.com/decred/dcrdata/stakedb/v3 v3.0.0
